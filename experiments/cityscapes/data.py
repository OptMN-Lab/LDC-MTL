...
class Cityscapes(Dataset):
    ...
    def __init__(self, root, train=True, augmentation=False):
        ...
        # read the data file
        if train:
            # self.data_path = 'gsmgrad/experiments/cityscapes' + '/train'
            self.data_path = 'your_data_path' + '/train'
        else:
            # self.data_path = 'gsmgrad/experiments/cityscapes' + '/val'
            self.data_path = 'your_data_path' + '/val'
