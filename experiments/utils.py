...
common_parser.add_argument("--grouping_freq", type=int, default=3)
# common_parser.add_argument("--n_groups", type=int, default=3)
...
common_parser.add_argument("--gpu", type=int, default=1, help="gpu device ID")
common_parser.add_argument("--seed", type=int, default=1, help="seed value")
# NashMTL
common_parser.add_argument(
